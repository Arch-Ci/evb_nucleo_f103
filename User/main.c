...
static void evb_setup_irq(int int_type)
{
    ...
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA|RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOC|RCC_APB2Periph_AFIO, ENABLE);//打开GPIO AFIO的时钟  
	if(int_type & QST_NUCLEOPB4_ACC_INT1)
	{
	    //RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB, ENABLE);//打开GPIO AFIO的时钟  
...
// add by yangzhiqiang
	...
	{
		//RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA, ENABLE);//打开GPIO AFIO的时钟  
