...
#if defined(ST_NUCLEO_BOARD)
#define      QST_SPI_CS_PORT                GPIOB
...
extern u8 qst_acc_spi_read(u8 addr, u8* buff, u16 len);
extern u8 qst_acc_spi_write(u8 addr,u8 data);
...
extern uint8_t qst_fisimu_spi_write(uint8_t Addr, uint8_t Data);
extern uint8_t qst_fisimu_spi_write_bytes(uint8_t Addr, uint8_t* Data, uint8_t Len);
//extern uint8_t qst_fisimu_spi_read(uint8_t Addr, uint8_t *pData, uint16_t Length);
extern uint8_t qst_8610_spi_read(uint8_t Addr, uint8_t *pData, uint16_t Length);
extern uint8_t qst_8658_spi_read(uint8_t Addr, uint8_t *pData, uint16_t Length);
